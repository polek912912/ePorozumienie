        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
          <div className="group backdrop-blur-sm bg-white/70 p-8 md:p-10 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-300 border border-[var(--glass-turquoise-border)] hover:border-[var(--turquoise)]/30 hover:-translate-y-1 hover:bg-white/80 relative">
            ...
            <p className="text-gray-600 leading-relaxed text-base">
              Pomóż naszemu mediatorowi AI zrozumieć sytuację. Opisz co się wydarzyło i prześlij dokumenty, skany lub inne materiały. Nasz bezstronny mediator AI zsynchronizuje Twoją narrację z faktami z plików, natychmiast wyodrębniając z nich kluczowe dane, daty i kwoty, tworząc obiektywny fundament sprawy. Jeśli będzie potrzeba więcej informacji, model zada Ci dodatkowe pytania, aby zyskać pełny i rzetelny obraz sprawy.
            </p>
          </div>
          <div className="group backdrop-blur-sm bg-white/70 p-8 md:p-10 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-300 border border-[var(--glass-turquoise-border)] hover:border-[var(--turquoise)]/30 hover:-translate-y-1 hover:bg-white/80 relative">
            <div className="w-16 h-16 bg-linear-to-br from-[#0A2463] to-[#051740] rounded-2xl flex items-center justify-center text-white font-bold text-2xl mb-6 shadow-lg shadow-[#0A2463]/30 group-hover:scale-110 group-hover:shadow-[var(--turquoise)]/20 transition-all duration-300 relative overflow-hidden">
            ...
            <p className="text-gray-600 leading-relaxed text-base">
              ...
              zidentyfikować realne interesy obu stron. nasz bezstronny mediator AI zrozumie Twoją sytuację. Nie poznasz stanowiska drugiej strony, aby znaleźć optymlanie najlepsze możliwe rozwiązanie sporu dla obu stron.
            </p>
          </div>
          <div className="group backdrop-blur-sm bg-white/70 p-8 md:p-10 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-300 border border-[var(--glass-turquoise-border)] hover:border-[var(--turquoise)]/30 hover:-translate-y-1 hover:bg-white/80 relative">
            <div className="w-16 h-16 bg-linear-to-br from-[#0A2463] to-[#051740] rounded-2xl flex items-center justify-center text-white font-bold text-2xl mb-6 shadow-lg shadow-[#0A2463]/30 group-hover:scale-110 group-hover:shadow-[var(--turquoise)]/20 transition-all duration-300 relative overflow-hidden">
            ...
            <p className="text-gray-600 leading-relaxed text-base">
              Możesz wybrać opcję skorzystania z usług projesjonalisty - certyfikowanego mediatora, który omówi z Toba i drugą stroną przebieg mediacji, zada dodatkowe pytania i omówi z Tobą przebieg mediacji. Udział profesjonalisty łączy technologiczną wydajność z ludzkim doświadczeniem i empatią. 
            </p>
          </div>
          <div className="group backdrop-blur-sm bg-white/70 p-8 md:p-10 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-300 border border-[var(--glass-turquoise-border)] hover:border-[var(--turquoise)]/30 hover:-translate-y-1 hover:bg-white/80 relative">
            <div className="w-16 h-16 bg-linear-to-br from-[#0A2463] to-[#051740] rounded-2xl flex items-center justify-center text-white font-bold text-2xl mb-6 shadow-lg shadow-[#0A2463]/30 group-hover:scale-110 group-hover:shadow-[var(--turquoise)]/20 transition-all duration-300 relative overflow-hidden">
          ...
          <div className="group backdrop-blur-sm bg-white/70 p-8 md:p-10 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-300 border border-[var(--glass-turquoise-border)] hover:border-[var(--turquoise)]/30 hover:-translate-y-1 hover:bg-white/80 relative md:col-span-2 md:w-[calc(50%-1rem)] mx-auto w-full">            <div className="w-16 h-16 bg-linear-to-br from-[#0A2463] to-[#051740] rounded-2xl flex items-center justify-center text-white font-bold text-2xl mb-6 shadow-lg shadow-[#0A2463]/30 group-hover:scale-110 group-hover:shadow-[var(--turquoise)]/20 transition-all duration-300 relative overflow-hidden">
              <div className="absolute inset-0 bg-linear-to-br from-[var(--turquoise)]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
